...
public class TakeOrder2 {
	...
	public String[] reachFoods() {

		String[] temp = new String[Management.getManagement().getAdmin().getStock().getFood().size()];
		int i = 0;
		for (Food f : Management.getManagement().getAdmin().getStock().getFood().values()) {
	...
	public String[] reachDrinks() {

		String[] temp = new String[Management.getManagement().getAdmin().getStock().getDrink().size()];
		int i = 0;
		for (Drink d : Management.getManagement().getAdmin().getStock().getDrink().values()) {
	...
	public TakeOrder2(final JFrame superF,  String employeeName, final int tableNumber) {
		frame = new JFrame();
		...
		cbxFoods.setModel(new DefaultComboBoxModel(reachFoods()));
		...
		cbxDrinks.setModel(new DefaultComboBoxModel(reachDrinks()));
		...
		cbxFoods.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblFoodPrice.setText("Unit Price: " + Management.getManagement().getAdmin().getStock().getFood()
		...
		cbxDrinks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblDrinkPrice.setText("Unit Price: " + Management.getManagement().getAdmin().getStock().getDrink()
		...
		btnPlusF.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblTotalFoodPrice.setText("Total Food Price: " + (Integer.parseInt(lblNumberF.getText()) * Management.getManagement().getAdmin()
			...
			public void actionPerformed(ActionEvent e) {
				if (!lblNumberF.getText().equals("0")) {
					...
					lblTotalFoodPrice.setText(
							"Total Food Price: " + (Integer.parseInt(lblNumberF.getText()) * Management.getManagement().getAdmin().getStock()
		...
		btnPlusD.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblTotalDrinkPrice.setText("Total Drink Price: " + (Integer.parseInt(lblNumberD.getText()) * Management.getManagement().getAdmin()
			...
			public void actionPerformed(ActionEvent e) {
				if (!lblNumberD.getText().equals("0")) {
					...
					lblTotalDrinkPrice.setText(
							"Total Drink Price: " + (Integer.parseInt(lblNumberD.getText()) * Management.getManagement().getAdmin().getStock()
		...
		btnOK.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				{
					Management.getManagement().addOrder(tableNumber,
							Management.getManagement().getAdmin().getStock().getFood().get(cbxFoods.getSelectedItem().toString()),
							Integer.parseInt(lblNumberF.getText()));
					Management.getManagement().addOrder(tableNumber,
							Management.getManagement().getAdmin().getStock().getDrink().get(cbxDrinks.getSelectedItem().toString()),
