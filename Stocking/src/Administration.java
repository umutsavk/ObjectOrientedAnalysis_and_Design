...
/*
	 ...
	 */
	public Administration(final JFrame frame) throws ParseException {
		...
		addEmpbtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Management.getManagement().getAdmin().employeeAdd(empNameText.getText(), Integer.parseInt(salaryText.getText()));
		...
		deleteEmployeeButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!Management.getManagement().getAdmin().getEmployees().isEmpty()) {
					String[] emp1 = new String[Management.getManagement().getAdmin().getEmployees().size()];
					int i=0;
					for (Employee em : Management.getManagement().getAdmin().getEmployees()) {
						emp1[i]=em.getName();
						i++;
					}
					...
					Delete.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							Management.getManagement().getAdmin().employeeDelete(deleteComboBox.getSelectedItem().toString());
							deleteEmployeePanel.setVisible(false);
						}
					});
				}
		...
		stockDisplayButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				foodTable.setModel(new DefaultTableModel(
						Management.getManagement().getAdmin().getStock().getFoodString(),
					new String[] {
				...
				drinkTable.setModel(new DefaultTableModel(
						Management.getManagement().getAdmin().getStock().getDrinkString(),
					new String[] {
						"Product Name", "Number Of Product", "Entry Date"
					}
				));
				...
				otherTable.setModel(new DefaultTableModel(
						Management.getManagement().getAdmin().getStock().getOtherString(),
					new String[] {
						"Product Name", "Number Of Product", "Entry Date"
					}
				));
				...
				addProductButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if (foodButton.isSelected()) {
							...
							if (Management.getManagement().getAdmin().newOrExistStock(productNameTxt.getText().toString().toLowerCase(), "Food", Integer.parseInt(numberOfProductTxt.getText().toString()))) {
								Management.getManagement().getAdmin().stockAdd(productNameTxt.getText().toString().toLowerCase(), "Food", Integer.parseInt(numberOfProductTxt.getText().toString()));
							}
							else {
								Product pr = Factory.productFactory(productNameTxt.getText().toString().toLowerCase(),Integer.parseInt(numberOfProductTxt.getText().toString()),
										Double.parseDouble(unitPurchasePriceTxt.getText().toString()),Double.parseDouble(unitSalePriceTxt.getText().toString()));
								Management.getManagement().getAdmin().addNewProduct(pr, "Food");
							}
					

						}
						else if (drinkButton.isSelected()) {
							if (Management.getManagement().getAdmin().newOrExistStock(productNameTxt.getText().toString().toLowerCase(), "Drink", Integer.parseInt(numberOfProductTxt.getText().toString()))) {
								Management.getManagement().getAdmin().stockAdd(productNameTxt.getText().toString().toLowerCase(), "Drink", Integer.parseInt(numberOfProductTxt.getText().toString()));
							}
							else {
								Product pr =Factory.productFactory(productNameTxt.getText().toString().toLowerCase(),Integer.parseInt(numberOfProductTxt.getText().toString()),
										Double.parseDouble(unitPurchasePriceTxt.getText().toString()),Double.parseDouble(unitSalePriceTxt.getText().toString()));
								Management.getManagement().getAdmin().addNewProduct(pr, "Drink");
							}
						}
						else if (otherButton.isSelected()) {
							if (Management.getManagement().getAdmin().newOrExistStock(productNameTxt.getText().toString().toLowerCase(), "Other", Integer.parseInt(numberOfProductTxt.getText().toString()))) {
								Management.getManagement().getAdmin().stockAdd(productNameTxt.getText().toString().toLowerCase(), "Other", Integer.parseInt(numberOfProductTxt.getText().toString()));
							}
							else {
								Product pr = Factory.productFactory(productNameTxt.getText().toString().toLowerCase(),Integer.parseInt(numberOfProductTxt.getText().toString()),
										Double.parseDouble(unitPurchasePriceTxt.getText().toString()),Double.parseDouble(unitSalePriceTxt.getText().toString()));
								Management.getManagement().getAdmin().addNewProduct(pr, "Other");
							}
						}
						else {
			...
			public void actionPerformed(ActionEvent e) {
				...
				findProductButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if (Management.getManagement().getAdmin().getStock().getFood().containsKey(deleteProductTxt.getText().toString().toLowerCase())) {
							productName=deleteProductTxt.getText().toString().toLowerCase();
							productType="Food";
							
							slider.setMaximum(Management.getManagement().getAdmin().getStock().getFood().get(productName).getNumberOfProduct());
							...
							deleteProductButton.addActionListener(new ActionListener() {
								public void actionPerformed(ActionEvent e) {
									...
									deleteFlag=true;
									if (!sliderFlag && slider.getValue()==Management.getManagement().getAdmin().getStock().getFood().get(productName).getNumberOfProduct()) {
										Management.getManagement().getAdmin().getStock().getFood().remove(productName);		
									
									}
									else if(!sliderFlag) {
										Management.getManagement().getAdmin().getStock().getFood().get(productName).
										setNumberOfProduct(Management.getManagement().getAdmin().getStock().getFood().get(productName).getNumberOfProduct()-valueTemp);
									}
									sliderFlag=true;
						...
						else if (Management.getManagement().getAdmin().getStock().getDrink().get(deleteProductTxt.getText().toString().toLowerCase())!=null) {
							productName=deleteProductTxt.getText().toString().toLowerCase();
							productType="Drink";
							
							slider.setMaximum(Management.getManagement().getAdmin().getStock().getDrink().get(productName).getNumberOfProduct());
							slider.setToolTipText("How many "+ productName+"s do you want to delete.");
							slider.addChangeListener(new ChangeListener() {
								public void stateChanged(ChangeEvent e) {
									deleteFlag=true;
							...
							deleteProductButton.addActionListener(new ActionListener() {
								public void actionPerformed(ActionEvent e) {
									deleteFlag=true;
									if (!sliderFlag && slider.getValue()==Management.getManagement().getAdmin().getStock().getDrink().get(productName).getNumberOfProduct()) {
										Management.getManagement().getAdmin().getStock().getDrink().remove(productName);								
									}
									else if(!sliderFlag){
										Management.getManagement().getAdmin().getStock().getDrink().get(productName).
										setNumberOfProduct(Management.getManagement().getAdmin().getStock().getDrink().get(productName).getNumberOfProduct()-valueTemp);
									}
									sliderFlag=true;
									stockDeletePanel.setVisible(false);
									resetStockDelete();
						...
						else if (Management.getManagement().getAdmin().getStock().getOther().get(deleteProductTxt.getText().toString().toLowerCase())!=null) {
							productName=deleteProductTxt.getText().toString().toLowerCase();
							productType="Other";
							
							slider.setMaximum(Management.getManagement().getAdmin().getStock().getOther().get(productName).getNumberOfProduct());
							slider.setToolTipText("How many "+ productName+"s do you want to delete.");
							slider.addChangeListener(new ChangeListener() {
								public void stateChanged(ChangeEvent e) {
									deleteFlag=true;
							...
							deleteProductButton.addActionListener(new ActionListener() {
								public void actionPerformed(ActionEvent e) {
									deleteFlag=true;
									if (!sliderFlag && slider.getValue()==Management.getManagement().getAdmin().getStock().getOther().get(productName).getNumberOfProduct()) {
										Management.getManagement().getAdmin().getStock().getOther().remove(productName);								
									}
									else if(!sliderFlag) {
										Management.getManagement().getAdmin().getStock().getOther().get(productName).
										setNumberOfProduct(Management.getManagement().getAdmin().getStock().getOther().get(productName).getNumberOfProduct()-valueTemp);
									}
									sliderFlag = true;
									stockDeletePanel.setVisible(false);
									resetStockDelete();
			...
			public void actionPerformed(ActionEvent e) {
				...
				showIncomeButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						int count=0;
						for (Map.Entry<String, Double> element : Management.getManagement().getAdmin().getDailyIncome().entrySet()) {
						...
						count=0;
						for (Map.Entry<String, Double> element : Management.getManagement().getAdmin().getDailyExpense().entrySet()) {
							if (isInInterval(date1,date2,element.getKey())) {
